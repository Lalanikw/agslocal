...
export default function SubmitPage({ params }: { params: Promise<{ questionId: string }> }) {
  ...
  if (success) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#1a407c]/15 to-[#FFDF29]/10 flex items-center justify-center px-4">
        <div className="bg-white rounded-lg shadow-xl p-8 max-w-md w-full text-center">
          <div className="w-16 h-16 bg-[#1a407c]/20 rounded-full flex items-center justify-center mx-auto mb-4">
